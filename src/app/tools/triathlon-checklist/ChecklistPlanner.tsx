...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'anti_chafe', label: 'Anti-chafe balm / Body Glide', tip: 'Apply to neck, wrists, ankles, and anywhere that might rub' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'baby_powder_t1', label: 'Baby powder (inside shoes)', tip: 'Helps dry wet feet instantly, especially if going sockless' },
      { id: 'sunglasses', label: 'Sunglasses' },
      { id: 'race_belt', label: 'Race number belt' },
      { id: 'sunscreen', label: 'Sunscreen (pre-applied or in transition)' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'baby_powder_t2', label: 'Baby powder (inside shoes)', tip: 'Prevents blisters on the run, absorbs sweat' },
      { id: 'blister_tape', label: 'Blister tape / plasters', tip: 'For known hot-spots on your feet or toes' },
